...
#echo "www-client/yandex-browser-beta" >> /etc/portage/package.accept_keywords/custom
#echo "app-crypt/cryptoprocsp-5.0.12000" >> /etc/portage/package.accept_keywords/custom
#echo "www-plugins/cades-2.0.14589" >> /etc/portage/package.accept_keywords/custom
